...
def doCompute(RTBOS):
	...
	if (lenght > n_neighbors):
		...
		for x in range (category_labels.shape[0]): #feature vector is dimensions (1,126)
			a=0
	...
	feature_memory.append(np.copy(feature_vector[0]))  # memory with feature_vectors; take out the close ones?
