...
def confidence_calc2(test_data,training_data, training_labels, neigh, n_neighbors, treshold1, treshold2, local_h, local_g):
    s = []
    ...
    outlier, sparse_region, dense_overlap, index_total = \
        overlap_detection_2(treshold1, treshold2, kappa1, gamma1, delta1, local_h, local_g)
