...
for i in range(16):
    ...
    if i < 4:
        ...
        if i==0:
            ...
            k_array = pickle.load(open("/hri/storage/user/jradojev/Version1/Strategies/Test3/k174.pickle", "rb"))
        if i==1:
    ...
    name = "/hri/storage/user/jradojev/Version1/Strategies/Training7+bnb/Training{}.pickle"
    pic = "/hri/storage/user/jradojev/Version1/Strategies/Training7+bnb/Training{}.png"
    ...
    name_class = "/hri/storage/user/jradojev/Version1/Strategies/Training7+bnb/Training_Rate{}.pickle"
