...
for i in range(16):
    ...
    name = "/hri/storage/user/jradojev/Version1/Strategies/Test3/Test{}.pickle"
    pic = "/hri/storage/user/jradojev/Version1/Strategies/Test3/Test{}.png"
    name_pic1 = "/hri/storage/user/jradojev/Version1/Baseline_data/Precision{}.png"
    with open(name.format(z), 'w') as f:
        pickle.dump([objId_list, objId_test_list, neuron_id, n_neighbors, f1, k, limit_test_views, repeat, treshold, local_h, perse, per_m], f)
    ...
    for t in range(repeat):
        ...
        neigh_param = KNeighborsClassifier(n_neighbors_param, algorithm='brute').fit(training_data_param,
                                                                                     training_labels_param)
        ...
        kappa_param, gamma_param, delta_param, indices_param = overlap_measures_temp(neigh_param, n_neighbors_param,
                                                                                     training_data_param, test_data_param)
        ...
        for e in number_of_training_samples_list:
            ...
            for objId in objId_test_list:
                ...
                confidence1, label1 = confidence_calc3(test_data, training_data, training_labels, neigh, n_neighbors, treshold3, perse, local_h)
                ...
                test_data, test_labels = get_views1([objId], view_test_list, data_location, neuron_id)
                confidence2, label2 = confidence_calc3(test_data, training_data, training_labels, neigh, n_neighbors, treshold3, perse, local_h)
        ...
        #
        # if t == 0:
        #     classification_min = classification_rate
        #     classification_max = classification_rate
        # else:
        #     if classification_min > classification_rate:
        #         classification_min = classification_rate
        #     if classification_max < classification_rate:
        #         classification_max = classification_rate
    ...
    name_class = "/hri/storage/user/jradojev/Version1/Strategies/Test3/Test_Rate{}.pickle"
    with open(name_class.format(z), 'w') as f:
        pickle.dump([classification_rate_average], f)

    # name_class_maxmin="Strategies/Test3/Test_RateMaxMin{}.pickle"
    # with open(name_class_maxmin.format(z), 'w') as f:
    #     pickle.dump([classification_max, classification_min], f)

    name_k = "/hri/storage/user/jradojev/Version1/Strategies/Test3/k{}.pickle"
    ...
    plt.title("Test: {} r, {} trobj, {} teobj, {} neuro, {} local_h, {} perse, {} per_m, {} neigh".format(repeat, len(objId_list), len(objId_test_list), len(neuron_id), local_h, perse, per_m, n_neighbors))
    plt.ylim([0, 1])
    ...
    # plt.title("Test: {} r, {} trobj, {} teobj, {} neuro, {} local_h, {} perse, {} per_m, {} neigh".format(repeat, len(
    #     objId_list), len(objId_test_list), len(neuron_id), local_h, perse, per_m, n_neighbors))
    # plt.ylim([0, 1])
    # plt.savefig(pic.format(z))
    # plt.show()
