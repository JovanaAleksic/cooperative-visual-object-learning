...
for i in [12,13,14,15,8,9,10,11,4,5,6,7,0,1,2,3]:
    ...
    name = "/hri/storage/user/jradojev/Version1/Strategies/Test3Training3/Training{}.pickle"
    pic = "/hri/storage/user/jradojev/Version1/Strategies/Test3Training3/Training{}.png"
    with open(name.format(z), 'w') as f:
        pickle.dump([objId_list, objId_test_list, neuron_id, n_neighbors, k, repeat, training_treshold, a_p, b_p, c_p, step, gog, perse, local_h, f1, limit_test_views, treshold], f)
    ...
    for t in range(repeat):
        ...
        for e in number_of_training_samples_list:
            ...
            for objId in objId_test_list:
                ...
                confidence1, label1 = confidence_calc3(test_data, training_data, training_labels, neigh, n_neighbors, treshold_t, perse, local_h)
                ...
                test_data, test_labels = get_views1([objId], view_test_list, data_location, neuron_id)
                confidence2, label2 = confidence_calc3(test_data, training_data, training_labels, neigh, n_neighbors, treshold_t, perse, local_h)
    ...
    name_class = "/hri/storage/user/jradojev/Version1/Strategies/Test3Training3/Training_Rate{}.pickle"
    with open(name_class.format(z), 'w') as f:
        pickle.dump([classification_rate_average], f)

    name_k = "/hri/storage/user/jradojev/Version1/Strategies/Test3Training3/k{}.pickle"
    ...
    plt.title("TtN: {}r, {}trobj, {}teobj, {}neur, {}x, {}per, {}local_h, {}neigh".format(repeat, len(objId_list), len(objId_test_list), len(neuron_id), gog, perse, local_h, n_neighbors_param))
    plt.ylim([0, 1])
