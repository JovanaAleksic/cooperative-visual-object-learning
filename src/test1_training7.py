...
# local_h = 2
# perse = 0.7
treshold1 = 0.015                                                                #maximum 10, 0 for not finiding new classes, 0 to leave out new objects
treshold2 = 0.5
...
for i in [12,13,14,15,8,9,10,11,4,5,6,7,0,1,2,3]:
    ...
    name = "/hri/storage/user/jradojev/Version1/Strategies/TestTraining7/Training{}.pickle"
    pic = "/hri/storage/user/jradojev/Version1/Strategies/TestTraining7/Training{}.png"
    with open(name.format(z), 'w') as f:
        pickle.dump([objId_list, objId_test_list, neuron_id, n_neighbors, k, repeat, training_treshold, a_p, b_p, c_p, step, gog, treshold1, treshold2, treshold, f1, limit_test_views, treshold2o], f)
    ...
    for t in range(repeat):
        ...
        treshold1o = gog*gamma_average
        treshold3 = c_p*treshold1o
        ...
        for e in number_of_training_samples_list:
            ...
            for objId in objId_list:
                ...
                for o in range(1000):   #has to be checked! not good! sometimes doesn't add enough data
                    ...
                    different_reward = different_views3(temporary_training, temporary_test, n_neighbors, neigh1, treshold1o, treshold2o, treshold3)
                    ...
                    if different_reward > training_treshold:
                        ...
                        if 150 >= leny > n_neighbors:
                            treshold1o = (gog - gog*(leny - n_neighbors) / float(150 - n_neighbors) *(1-a_p/gog)) * gamma_average
                            treshold3 = c_p*treshold1o
    ...
    name_class = "/hri/storage/user/jradojev/Version1/Strategies/TestTraining7/Training_Rate{}.pickle"
    with open(name_class.format(z), 'w') as f:
        pickle.dump([classification_rate_average], f)

    name_k = "/hri/storage/user/jradojev/Version1/Strategies/TestTraining7/k{}.pickle"
    ...
    plt.xlabel("Number of training samples per object")
    plt.ylabel("Correct classification rate")
    plt.title("Tt: {} runs, {} trobj, {} teobj, {} neuro, {} x, {} per, {} neigh, {} tres1".format(repeat, len(objId_list), len(objId_test_list), len(neuron_id), gog, per, n_neighbors_param, treshold1))
    plt.ylim([0, 1])
