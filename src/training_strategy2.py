...
# z = 1
# pickle.dump(z, open("Strategies/Training2/number.pickle", "wb"))

z = pickle.load(open("Strategies/Training2/number.pickle", "rb"))

z += 1

pickle.dump(z, open("Strategies/Training2/number.pickle", "wb"))

name = "Strategies/Training2/Training{}.pickle"
pic = "Strategies/Training2/Training{}.png"
    ...
    for e in number_of_training_samples_list:
        ...
        for objId in objId_list:
            ...
            for i in range(1000):
                # print i
                if (j+i) < 1000:
                    temporary_test_index = [int(total_training_data[j+i])]    #you can use %1000 instead of if
                else:
                    temporary_test_index = [int(total_training_data[j + i-1000])]
                ...
                different_reward = different_views(temporary_training, temporary_test, n_neighbors, neigh1, treshold1, treshold2, treshold3)
            ...
            if objId_list.index(objId) == 0:      #reverse these things for higher speed
            ...
            print("Added {} training samples".format(len(temporary_labels)))  #WEIRD WRONG NUMBERS, CHECK THIS!!!
...
name_class = "/hri/storage/user/jradojev/Version1/Strategies/Training2/Training_Rate{}.pickle"
